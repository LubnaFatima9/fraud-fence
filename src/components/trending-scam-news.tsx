...
export function TrendingScamNews({ initialNews }: { initialNews: NewsData }) {
  ...
  return (
    <section className="w-full bg-muted/50 py-12 md:py-24 dark:bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] dark:from-blue-900/80 dark:via-purple-900/80 dark:to-magenta-900/80">
