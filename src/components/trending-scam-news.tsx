...
export function TrendingScamNews({ initialNews }: { initialNews: NewsData }) {
  ...
  return (
    <section className="w-full bg-muted/50 py-12 md:py-24 dark:bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] dark:from-blue-950 dark:via-purple-950 dark:to-slate-900">
