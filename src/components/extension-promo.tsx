...
export function ExtensionPromo() {
  return (
    <section className="w-full bg-primary/10 backdrop-blur-sm border-t border-b border-white/20 dark:bg-gradient-to-r dark:from-purple-800/60 dark:to-blue-700/60 dark:border-white/10">
